...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_NICOLA] = LAYOUT(
		...
		KC_TRNS, KC_NO  , KC_LALT,       KC_SPC, NG_SHFTL,        NG_SHFTR,KC_SPC,JP_HENK, MO(_FUNC),KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
 [_SMODI] = LAYOUT(
		KC_ESC,  KC_F1,   KC_F2,  KC_F3,  KC_F4,  KC_F5,   KC_F6,   KC_F7,  KC_F8,  KC_F9,   KC_F10,   KC_F11,  KC_F12,  S(KC_DEL),  KC_PSCR,
		...
		KC_TRNS, JP_COLN ,S(KC_Q),S(KC_J),S(KC_K),S(KC_X), S(KC_ENT),  S(KC_B),S(KC_M),S(KC_W), S(KC_V),  S(KC_Z), KC_RSFT, S(KC_UP),
		S(KC_LCTL), S(KC_LGUI)  , S(KC_LALT),     S(KC_SPC), KC_TRNS ,         KC_TRNS,S(KC_SPC), S(KC_RALT), MO(_FUNC),S(KC_RCTL), S(KC_LEFT), S(KC_DOWN), S(KC_RGHT)),
  [_QWERTY] = LAYOUT(
		KC_ESC,  KC_F1,   KC_F2, KC_F3,  KC_F4,  KC_F5,   KC_F6,   KC_F7, KC_F8,  KC_F9,   KC_F10, KC_F11,  KC_F12,  KC_DEL,  KC_PSCR,
